					...
					<div class="row">
						...
						<div class="col-lg-4 col-4">
							...
							<div class="small-box bg-primary">
								<div class="inner">
									<center>
										<h3><i class="fas fa-thermometer nav-icon"></i>&nbsp;PH</h3>
						...
						<div class="modal-body">
							<form>
								<div class="form-group">
									...
									<center><img src="<?= base_url("/assets/dist/img/grafikk output.JPG") ?>" width="500px"
				...
				<div class="modal-content">
					...
					<form>
						<div class="container">
							...
							<p>
								<h5 class="text-justify">
									Aplikasi Identifikasi Kualitas Air Kolam Udang Vanname
									adalah aplikasi yang digunakan untuk mengidentifikasi dan memonitoring kualitas air kolam udang vanname berdasarkan hasil pengukuran sensor suhu, pH, dan salinitas
								</h5>
							</p>
							</div>
						</div>	
